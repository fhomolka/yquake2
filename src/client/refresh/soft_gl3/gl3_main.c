...
GL3_SetMode(void)
{
	...
	else
	{
		...
		{
			R_Printf(PRINT_ALL, "ref_soft_gl3::GL3_SetMode() - invalid mode\n");
		...
		{
			R_Printf(PRINT_ALL, "ref_soft_gl3::GL3_SetMode() - could not revert to safe mode\n");
			return false;
		}
	}
...
GL3_Init(void)
{
	...
	if(sizeof(float) != sizeof(GLfloat))
	{
		...
		R_Printf(PRINT_ALL, "ref_soft_gl3: sizeof(float) != sizeof(GLfloat) - we're in real trouble here.\n");
		return false;
	}
	...
	if (!GL3_SetMode())
	{
		R_Printf(PRINT_ALL, "ref_soft_gl3::R_Init() - could not R_SetMode()\n");
		return false;
	}
